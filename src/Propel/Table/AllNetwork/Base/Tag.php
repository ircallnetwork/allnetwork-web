...
abstract class Tag implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Table\\AllNetwork\\Map\\TagTableMap';
    ...
    /**
     * The value for the tag_status field.
     * 
     * Note: this column has a database default value of: 'y'
     * @var        string
     */
    protected $tag_status;

    /**
     * The value for the tag_totalpost field.
     * 
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $tag_totalpost;
    ...
    {
        $this->tag_status = 'y';
        $this->tag_totalpost = 0;
    }

    /**
     * Initializes internal state of Propel\Table\AllNetwork\Base\Tag object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [tag_status] column value.
     * 
     * @return string
     */
    ...
    /**
     * Get the [tag_totalpost] column value.
     * 
     * @return int
     */
    public function getTagTotalpost()
    {
        return $this->tag_totalpost;
    }
     ...
     * @return $this|\Propel\Table\AllNetwork\Tag The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [tag_status] column.
     * 
     * @param string $v new value
     * @return $this|\Propel\Table\AllNetwork\Tag The current object (for fluent API support)
     */
    public function setStatus($v)
    {
        ...
        if ($this->tag_status !== $v) {
            $this->tag_status = $v;
            $this->modifiedColumns[TagTableMap::COL_TAG_STATUS] = true;
        }
    ...
    /**
     * Set the value of [tag_totalpost] column.
     * 
     * @param int $v new value
     * @return $this|\Propel\Table\AllNetwork\Tag The current object (for fluent API support)
     */
    public function setTagTotalpost($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->tag_totalpost !== $v) {
            $this->tag_totalpost = $v;
            $this->modifiedColumns[TagTableMap::COL_TAG_TOTALPOST] = true;
        }
    ...
    public function setNbPosts($v)
    {
        ...
        if ($this->nb_posts !== $v) {
            $this->nb_posts = $v;
            $this->modifiedColumns[TagTableMap::COL_NB_POSTS] = true;
        }
    ...
    {
            if ($this->tag_status !== 'y') {
                return false;
            }

            if ($this->tag_totalpost !== 0) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TagTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TagTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TagTableMap::translateFieldName('TagTotalpost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_totalpost = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TagTableMap::translateFieldName('NbPosts', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Table\\AllNetwork\\Tag'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TAG_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'tag_status';
        }
        if ($this->isColumnModified(TagTableMap::COL_TAG_TOTALPOST)) {
            $modifiedColumns[':p' . $index++]  = 'tag_totalpost';
        }
        if ($this->isColumnModified(TagTableMap::COL_NB_POSTS)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'tag_name':                        
                        ...
                        break;
                    case 'tag_status':                        
                        $stmt->bindValue($identifier, $this->tag_status, PDO::PARAM_STR);
                        break;
                    case 'tag_totalpost':                        
                        $stmt->bindValue($identifier, $this->tag_totalpost, PDO::PARAM_INT);
                        break;
                    case 'nb_posts':                        
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getTagTotalpost(),
            $keys[3] => $this->getNbPosts(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Table\AllNetwork\Tag
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setTagTotalpost($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNbPosts($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Table\AllNetwork\Tag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_TAG_STATUS)) {
            $criteria->add(TagTableMap::COL_TAG_STATUS, $this->tag_status);
        }
        if ($this->isColumnModified(TagTableMap::COL_TAG_TOTALPOST)) {
            $criteria->add(TagTableMap::COL_TAG_TOTALPOST, $this->tag_totalpost);
        }
        if ($this->isColumnModified(TagTableMap::COL_NB_POSTS)) {
            $criteria->add(TagTableMap::COL_NB_POSTS, $this->nb_posts);
        }
    ...
    /**
     * Generic method to set the primary key (tag_name column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Table\AllNetwork\Tag (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTagTotalpost($this->getTagTotalpost());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Table\AllNetwork\Tag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        $this->tag_name = null;
        $this->tag_status = null;
        $this->tag_totalpost = null;
        $this->nb_posts = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
    ...
    /**
     * Computes the value of the aggregate column nb_posts *
     * @param ConnectionInterface $con A connection object
     *
     * @return mixed The scalar result from the aggregate query
     */
    public function computeNbPosts(ConnectionInterface $con)
    {
        $stmt = $con->prepare('SELECT COUNT(posttag_post) FROM posttag WHERE posttag.POSTTAG_TAG = :p1');
        $stmt->bindValue(':p1', $this->getName());
        $stmt->execute();
    ...
    /**
     * Updates the aggregate column nb_posts *
     * @param ConnectionInterface $con A connection object
     */
    public function updateNbPosts(ConnectionInterface $con)
    {
        $this->setNbPosts($this->computeNbPosts($con));
        $this->save($con);
    }
